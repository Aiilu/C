...
Employee* employee_newParametros(char* idStr,char* nombreStr,char* horasTrabajadasStr)
{
    ...
    if (idStr != NULL && nombreStr != NULL && horasTrabajadasStr != NULL)
    {
        ...
        if( this != NULL)
        {
            ...
            if( !employee_setId(this, atoi(idStr))|| !employee_setNombre(this, nombreStr) || !employee_setHorasTrabajadas(this, atoi(horasTrabajadasStr)))
...
Employee* employee_newParametros2(char* idStr,char* nombreStr,char* horasTrabajadasStr)
{
    Employee* this;
    ...
    if (idStr != NULL && nombreStr != NULL && horasTrabajadasStr != NULL)
    {
        ...
        if( this != NULL)
        {
            ...
            if( !employee_setId(this, atoi(idStr))|| !employee_setNombre2(this, nombreStr) || !employee_setHorasTrabajadas(this, atoi(horasTrabajadasStr)))

            {
                printf("El empleado con id %d no fue cargado, razon: datos invalidos. \n",this->id);
                employee_delete(this);
                this = NULL;
            }
        }
...
void mostrarEmpleado(Employee* pEmp)
{
    ...
    if(pEmp !=NULL)
    {
        if(employee_getId(pEmp,&id) && employee_getNombre(pEmp,nombre) && employee_getHorasTrabajadas(pEmp,&horas))
        {
            printf("%5d %8s %6d\n",id,nombre,horas);
        }
    }
