...
int controller_ListEmployeeTres(LinkedList* pArrayListEmployee)
{
    int retorno = 0;

    if(pArrayListEmployee !=NULL)
    {
        if(listarEmpleados3(pArrayListEmployee))
        {
            printf(" Empleados listados con exito!!!\n");
            retorno = 1;
        }
...
int controller_saveAsTextTres(char* path, LinkedList* pArrayListEmployee)
{
    int retorno = -1;
    FILE* pFile;
    ...
    if(path !=NULL && pArrayListEmployee !=NULL)
    {
        ...
        if(pFile !=NULL)
        {
            if(parser_EmployeeSaveTextTres(pFile,pArrayListEmployee))
            {
                printf(" Empleados cargados en modo texto con exito!!!\n");
                retorno = 0;
            }
...
int controller_map(LinkedList* pArrayListEmployee, LinkedList* lista)
{
    int retorno = -1;

    if(pArrayListEmployee != NULL)
    {
        //ll_map2(pArrayListEmployee,calcularComision);
        //lista = ll_map1(pArrayListEmployee,calcularComision2);
