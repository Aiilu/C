...
int parser_EmployeeSaveTextDos(FILE* pFile, LinkedList* pArrayListEmployee, LinkedList* pp)
{
    ...
    if(pFile !=NULL && pArrayListEmployee !=NULL)
    {
            fprintf(pFile,"id_venta,nombre,apellido,dni,codProducto,montoTotal\n");
...
int parser_EmployeeSaveTextTres(FILE* pFile, LinkedList* pArrayListEmployee, LinkedList* pp)
{
    int retorno = 0;
    eVentas* nuevoEmpleado;
    ...
    if(pFile !=NULL && pArrayListEmployee !=NULL)
    {
            fprintf(pFile,"id_venta,id_cliente,codProd,cantidad,precioUnitario\n");
            ...
            for(int i=0; i<ll_len(pArrayListEmployee); i++)
            {
                ...
                if(nuevoEmpleado !=NULL)
                {
                    fprintf(pFile,"%d,%d,%d,%d,%f\n",nuevoEmpleado->idVenta,nuevoEmpleado->idCliente,nuevoEmpleado->codProd,nuevoEmpleado->cant, nuevoEmpleado->total);
                }
            }
